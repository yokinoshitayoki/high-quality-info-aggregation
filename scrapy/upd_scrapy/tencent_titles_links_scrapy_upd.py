...
def fetch_qq_titles_update(existing_titles, max_scrolls=30, wait_time=1):
    """增量更新腾讯网标题，遇到重复标题时停止"""
    new_titles = []
    new_title_link_dict = {}
...
if __name__ == "__main__":
    ...
    # 增量爬取新标题
    new_titles, new_title_link_dict = fetch_qq_titles_update(existing_titles, max_scrolls=30, wait_time=1)
